    ...
    <div class="row mt-5 justify-content-between">
      ...
      <div class="col-md-7">
        ...
        <div class="mb-3">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="status_pembayaran" id="belum-lunas" value="Belum Lunas" {{ $showroom->status === "Belum Lunas" ? "checked" : "disabled" }}>
            <label class="form-check-label" for="belum-lunas">Belum Lunas</label>
          </div>
        </div>
        <a href="/showrooms/{{ $showroom->id }}/edit" class="btn btn-primary mb-5">Edit</a>
      </div>
    </div>
  </div>
@endsection