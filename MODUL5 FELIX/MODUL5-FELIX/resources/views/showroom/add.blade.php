      ...
      <div class="col-10">
        <form action="/showrooms" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" name="image" type="file" id="image" required accept="image/*">
          </div>
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="status" id="belum-lunas" value="Belum Lunas" required>
