...
$sql = "SELECT * FROM showroom_felix_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car | Felix_1202204268</title>
      ...
      while ($getDetail = mysqli_fetch_array($result)) {
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  <img src='../asset/image/" . $getDetail["foto_mobil"] . "' alt='foto_mobil'>
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Felix.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
